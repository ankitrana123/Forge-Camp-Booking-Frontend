...
export class UpdateCampComponent implements OnInit {
   ...
   */
    ...
    this.services.getCampById(this.campId).subscribe((response: ICamp) => {
      ...
      this.campForm.controls['amount'].setValue(this.Camp.amount);
      this.campForm.controls['capacity'].setValue(this.Camp.capacity);
      this.campForm.controls['description'].setValue(this.Camp.description);
      this.campForm.controls['title'].setValue(this.Camp.title);
    });
  }
  ...
  OnFormSubmit() {
    ...
    this.services.updateCamp(this.campForm.value).subscribe(() => {
